...
<html lang="en">
    ...
    <body>
        <div id="tarea1">
            ...
            <div id="divContenido">
                <h2>Bienvenido a la tarea 1</h2>
                <p>
                    Esta tarea tiene como objetivo reforzar tus habilidades básicas en PHP mediante la creación de varias páginas interactivas. 
